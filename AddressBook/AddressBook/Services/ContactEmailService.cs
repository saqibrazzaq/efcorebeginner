...
namespace AddressBook.Services
{
    public class ContactEmailService : IContactEmailService
    {
        ...
        public bool AnyEmail(int emailLabelId)
        {
            return _repositoryManager.ContactEmailRepository.FindByCondition(
                x => x.EmailLabelId == emailLabelId,
                false)
                .Any();
        }
        ...
        public int Count()
        {
            return _repositoryManager.ContactEmailRepository.FindAll(false)
                .Count();
        }
    }
}
